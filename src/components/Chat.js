...
import { chatData } from '../testData/TestData';

const Chat = () => {

  return (
    <div className="nav-item absolute right-5 md:right-48 top-16 shadow-2xl bg-white dark:bg-[#42464D] p-8 rounded-lg w-150">
